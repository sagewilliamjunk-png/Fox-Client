...
> **Status:** v1.3.2 — Stable &nbsp;|&nbsp; [⬇ Download Fox Launcher](https://github.com/sagewilliamjunk-png/Fox-Client/releases/latest)
...
2. Drop `kitsune-client-1.3.2.jar` and the matching `fabric-api` jar into your `mods/` folder.
3. Launch.

## Build from source

```bash
./gradlew build          # produces build/libs/kitsune-client-1.3.2.jar
